//tealium universal tag - utag.27 ut4.0.201908221243, Copyright 2019 Tealium.com Inc. All Rights Reserved.
...
if(xiti_type==="load"){if(b.immo_sell_type==="new"){b.subcat_id="73";}
if(xiti_label==="p2p::messaging")
{xiti_label="p2p";var f1="messaging";xiti_label+="&f1="+f1;}
else if(xiti_label==="ad_reply::online_booking"||xiti_label==="ad_reply::online_booking::sticky"||xiti_label==="ad_reply::online_booking::tabbar")
{var f="&f1="+
b.listid+
"&f2="+
"!!pending_adid!!"+
...
else if(b.eventname==="ad_view::detail"||xiti_label==="ad_view::voir_disponibilites"){var x6="";if(xiti_label==="ad_reply::telephone::voir_le_numero"||xiti_label==="ad_reply::telephone::appeler_le_vendeur"){x6="ad_reply_phone";}
...
if(xiti_label.startsWith("ad_reply::p2p::buyer")){var button_type=xiti_label.split('::');button_type=button_type[3];if(button_type===undefined){button_type="main";}
if(xiti_label.startsWith("ad_reply::p2p::buyer::tabbar")||xiti_label.startsWith("ad_reply::p2p::buyer::sticky")){xiti_label="ad_reply::p2p::buyer";button_type=button_type.split('&');button_type=button_type[0];}
if(b.eventname!=="ad_view::detail"){var f="&f1="+
b.listid+
"&f2="+
"!!pending_adid!!"+
"&f3="+
...
b.offres+
"&f19="+
b.boutique_id;f+="&f20="+button_type;xiti_label+=f;x+="&x7="+
(b.listid!=undefined?b.listid:"")+
"&x9="+
(b.cat_id!=undefined?b.cat_id:"")+
"&x10="+
...
(b.city!=undefined?b.city:"")+
"&x21="+
(b.boutique_id!=undefined?b.boutique_id:"");}else if(b.eventname==="ad_view::detail"&&(button_type==="sticky"||button_type==="tabbar")){var f="&f1="+
b.listid+
"&f2="+
"!!pending_adid!!"+
"&f3="+
...
b.offres+
"&f19="+
b.boutique_id;f+="&f20="+button_type;xiti_label+=f;}else if(b.eventname==="ad_view::detail"&&button_type==="main"){f="&f20="+button_type;xiti_label+=f;}else{var f="&f1="+
b.listid+
"&f2="+
"!!pending_adid!!"+
"&f3="+
...
b.offres+
"&f19="+
b.boutique_id;f+="&f20="+button_type;xiti_label+=f;}}
